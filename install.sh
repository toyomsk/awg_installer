...
main() {
    ...
    # Меню: при существующей установке — только меню действий (1–5), иначе — выбор типа установки (1–4)
    if check_existing_installation; then
        log_info "Обнаружена существующая установка"
        show_installation_menu
        # Если мы здесь после reinstall или выбора переустановки, продолжаем установку
    else
        show_start_menu
    fi
